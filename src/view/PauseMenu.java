...
public class PauseMenu extends JFrame {
    ...
    public PauseMenu(Timer timer,ArrayList<int[]> mapArrayList, FrameCloseListener listener, ArrayList<Integer> playerInventory, double score, int remainingChance) {
        ...
        saveButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                GameSlotsFrame gameSlotsFrame = new GameSlotsFrame(mapArrayList,listener,timer, playerInventory, score, remainingChance);
